...
<head>
    ...
    <style>
        ...
        .prescription-container { background: white; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.05); padding: 20px; }
        .alert { border-radius: 8px; }
        .form-label { font-weight: 500; color: #495057; }

        /* Mobile-specific styles */
        @media (max-width: 768px) {
            .prescription-container { padding: 0 10px; border-radius: 0; box-shadow: none; }
